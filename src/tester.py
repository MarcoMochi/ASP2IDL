...
def create_solver():
    ...
    path = ["/opt/homebrew/bin/yices 600-smt2"]
    ...
    for domain in domains:
        ...
        for file in problem_files:
            ...
            if out_path+"/"+name_file not in already_translated:
                ...
                writer(model, defs, name_file, out_path + "/", True, number)
            ...
            starting_time = time.time()
            os.system(f"yices-smt2 '{out_path}/{name_file}' --stats -t 1200 > '{out_path}/yices/{name_file}'")
            ending_time = time.time()
